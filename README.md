...
- To maintain privacy and encourage creative flexibility, a new logo, brand name, and product line were designed specifically for this project — avoiding the use of any real commercial identities.
...
- Microsoft Excel → for initial data exploration, cleaning, and pivot-based summaries

- Microsoft Power BI → for advanced dashboards, data modeling, and interactive reports

- DAX Language → for creating KPIs, ratios, and dynamic performance measures
...
- Top-Performing Brand — Purevia: Led the portfolio with $655.7K profit and the highest profit efficiency (68.23%).

- Demonstrated optimal pricing and cost control strategies.

- Most Profitable Retailer — Sodapop with total profit ($1.65M).

### Seasonal Sales Trend

- Sales and profit increased sharply from May to August, peaking in July ($384.7K profit) — consistent with summer beverage demand.
...
### 🧭 Overview:
<img width="863" height="483" alt="1-Overview" src="https://github.com/user-attachments/assets/d1b3551a-0457-4ef2-b1ed-5c5270f4c22d" />
